 ...
 */
package uk.ac.ox.it.ords.api.audit.resources.documentation;
...
public class Swagger extends Swagger2Feature {
	...
	public Swagger(){
		super();
		this.setBasePath("/api/1.0/audit/");
		this.setDescription("API for accessing ORDS audit data");
		this.setTitle("ORDS Audit API");
		this.setVersion("1.0");
